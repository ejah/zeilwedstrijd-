...
password_urls = [
    ...
    url(r'^wijzigen/$', auth_views.password_change,
        ...
        name="pw_change"),
    url(r'^wijzigen/gereed/$', auth_views.password_change_done, {'template_name': "user/password_change_done.html"},
        name="pw_change_done"),
    url(r'reset/$', auth_views.password_reset, {"template_name": "user/password_reset_form.html",
        ...
        name='pw_reset_start'),
    url(r'^reset/verzonden/$', auth_views.password_reset_done, {"template_name": "user/password_reset_sent.html"},
        name="pw_reset_sent"),
    url(r'^reset/'
    ...
    url(r'^reset/gereed/$', auth_views.password_reset_complete,
